 ...
 */
public class CreateItemViewAction extends AnAction {
  private static final Logger LOG = Logger.getInstance(CreateItemViewAction.class.getName());
  ...
  public void actionPerformed(@NotNull AnActionEvent e) {
    ...
    String name = Messages.showInputDialog(project, "Creating new item view",
        "Name", MarionetteCoffeeIcons.ITEM_16, MarionetteCoffeeConstants.ITEM_VIEW, null);
    if (name == null)
      return;
    ...
    PsiFile viewFile = componentDir.findFile(lowerName + MarionetteCoffeeConstants.ITEM_VIEW_COFFEE);
    if (viewFile != null)
  ...
  private boolean createCompositeViewStructure(@NotNull final String path, @NotNull final String upperName,
    ...
    try {
      ...
      URL url = CreateCompositeViewAction.class.getClassLoader().getResource("templates/item_view/");
